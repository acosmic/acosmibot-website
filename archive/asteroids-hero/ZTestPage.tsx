...
import { HeroAsteroids } from '@/components/HeroAsteroids';
import '@/styles/home.css';

// ── /z-test ────────────────────────────────────────────────────────────
// Preview copy of HomePage with the ambient Asteroids hero background.
// Reuses home.css verbatim so it's pixel-identical to the live homepage.
// If approved: fold <HeroAsteroids/> into HomePage and delete this file + route.
...
export const ZTestPage: React.FC = () => {
  ...
  return (
    <div className="home-page">
      ...
      {/* ── Hero ────────────────────────────────────────────── */}
      {/* isolation:isolate gives the hero its own stacking context so the
          canvas (z0) and veil (z1) stay behind the content (z2). */}
      <section className="hero" style={{ isolation: 'isolate' }}>
        <HeroAsteroids />
        <div className="home-container">
