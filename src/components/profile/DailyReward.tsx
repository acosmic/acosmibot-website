        ...
        <div style={{ fontSize: '14px', color: 'var(--text-muted)', marginTop: '2px' }}>
          {justClaimed ? (
            <span className="dr-reward-pop" style={{ color: 'var(--primary-color)', fontWeight: 700 }}>
              +{claim.data!.reward.toLocaleString()} Acosmicoins added to your bank — withdraw in any server!
            </span>
          ) : data.can_claim
            ? `Claim +${data.next_reward.toLocaleString()} Acosmicoins to your bank (day ${data.next_streak.toLocaleString()}). Resets in ${resetIn}.`
