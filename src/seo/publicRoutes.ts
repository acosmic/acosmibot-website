...
export const FEATURE_LANDINGS: Record<string, FeatureLandingDefinition> = {
  'ai-discord-bot': {
    ...
    related: [
      ...
      { label: 'Discord economy bot', path: '/features/discord-economy-bot', description: 'Connect credits, banking, items, daily rewards, transfers, and community progression.' },
  ...
  'discord-leveling-bot': {
    ...
    related: [
      { label: 'Discord economy bot', path: '/features/discord-economy-bot', description: 'Let activity, credits, items, boosts, and rewards reinforce one another.' },
      { label: 'Discord games bot', path: '/features/discord-games-bot', description: 'Add competitive game statistics and credit-based play to community progression.' },
  ...
  'discord-economy-bot': {
    ...
    title: 'A Discord economy bot where credits connect the whole community.',
    ...
    shortDescription: 'A connected Discord economy with credits, banking, daily rewards, transfers, items, inventory, leaderboards, lottery, and games.',
    promise: 'The economy is not an isolated balance command. Credits move through rewards, banking, items, games, good deeds, donations, heists, and public progression while Acosmibot keeps global and server balances consistent.',
    ...
    capabilities: [
      { title: 'Earn and move credits', description: 'Members can receive daily rewards, win games, collect mystery Good Deeds, transfer credits, and donate to the server guild vault.' },
      { title: 'Bank across communities', description: 'Move credits between a server wallet and a separate global bank with deposit and withdrawal history.' },
      { title: 'Build a useful item loop', description: 'Spend credits in the shop, hold a personal inventory, equip persistent effects, activate consumables, and gift or trade items.' },
    ...
    steps: [
      { title: 'Members earn credits', description: 'Daily rewards, games, transfers, events, and Good Deeds create understandable sources of currency.' },
      { title: 'Credits move through the system', description: 'Members bank, give, donate, buy items, enter lotteries, or place game wagers.' },
    ...
    demonstration: {
      ...
      note: 'Acosmibot credits are virtual community currency with no real-world monetary value.',
    },
    related: [
  ...
  'discord-games-bot': {
    ...
    highlights: ['Interactive Discord UI', 'Credit-based play', 'Live game records', 'Per-game controls'],
    capabilities: [
      { title: 'Play familiar casino games', description: 'Blackjack, slots, mines, keno, and coinflip combine quick Discord interaction with the shared credit economy.' },
    ...
    steps: [
      ...
      { title: 'Credits settle consistently', description: 'Wins and losses use the same synchronized economy path as transfers, banking, items, and leaderboards.' },
