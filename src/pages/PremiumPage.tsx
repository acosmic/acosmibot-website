...
const TIERS: TierCardDef[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: '20% XP boost for leveling' },
      { text: 'Custom currency & embed colors' },
      { text: 'Custom level-up messages' },
      { text: 'Priority support' },
      { text: 'Same AI as Free (20/day, GPT-3.5)' },
    ],
  },
  {
    ...
    features: [
      ...
      { text: '100 AI messages/day (5x more)' },
      { text: 'Advanced AI models (GPT-4, GPT-4 Turbo, GPT-4o)' },
      { text: '50 AI images/month (generation)' },
      { text: '100 image analyses/month' },
    ],
  },
];
